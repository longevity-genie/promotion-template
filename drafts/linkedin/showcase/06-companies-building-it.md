...
The "this is not science fiction" post. These genes are not hypothetical - companies are already turning them into therapies, some in alternative jurisdictions where regulation moves faster. Tag every company with a LinkedIn presence. This post should generate the most engagement because tagging companies puts it in front of their followers.

## Before posting: verify LinkedIn handles

Find and verify the LinkedIn company pages for each tagged organization. Some may not have pages. Update the tag list below.

## Companies to tag (verify handles before posting)

| Company | Gene/therapy | Stage | Where |
|---|---|---|---|
| Verve Therapeutics (Eli Lilly) | PCSK9 base editing | Phase 1 in humans | USA (FDA) |
| Verve Therapeutics | ANGPTL3 base editing | Phase 1b | USA (FDA) |
| CRISPR Therapeutics | ANGPTL3 gene editing | Phase 1 | USA (FDA) |
| Ionis Pharmaceuticals | APOC3 knockdown (Tryngolza) | Marketed | USA (FDA) |
| Arrowhead Pharmaceuticals | APOC3 silencing (Plozasiran) | Phase 3 / marketed | USA (FDA) |
| Dompe Farmaceutici | NGF for corneal nerve (Oxervate) | Marketed | EU / USA |
| Toregem BioPharma | USAG-1 antibody for tooth regrowth | Phase 1-2 | Japan |
| Regeneron | ANGPTL3 antibody (Evkeeza) | Marketed | USA (FDA) |
| Life Biosciences | OSK partial reprogramming (vision) | Phase 1 | USA (FDA) |
| Rejuvenate Bio | FGF21 + sTGFbR2 gene therapy | Pilot in dogs | USA |
| Paratus Sciences | Bat ASC2 inflammasome suppressor | Preclinical ($100M Series A) | USA |
| Jocasta Neuroscience | Alpha-Klotho protein | Preclinical ($35M Series A) | USA |
| Klotho Neurosciences | Alpha-Klotho AAV (ALS) | Preclinical (FDA orphan drug) | USA |
| Loyal | IGF-1 pathway (canine aging) | FDA reasonable expectation | USA |
| Minicircle | Follistatin + Klotho plasmid | Commercial / Phase 1 | Prospera ZEDE, Honduras |
| Unlimited Bio | Follistatin AAV + VEGF | Phase 1/2a | Prospera ZEDE, Honduras |
| Klothea Bio | Alpha-Klotho mRNA | Phase 1b | Prospera ZEDE, Honduras |
| BioViva Sciences | TERT + Follistatin AAV | Commercial | Prospera ZEDE |
| Artgen / Nextgen | VEGF plasmid (Neovasculgen) | Marketed since 2011 | Russia |
| Quantum Longevity AI | Regenerative therapies | Opening 2026 | LARTA, Bahamas |
...
- Regeneron sells Evkeeza (ANGPTL3 antibody) for familial hypercholesterolemia
